...
<title>Tambah Dosen - Sistem Monitoring Ruangan</title>
...
<div style="margin:auto">
	<form action="doseninsert.php" method="post" style="width:400px; margin:auto; background-color: #ffffff;" class="z-depth-4">
		<fieldset>
          ...
          <input id="icon_prefix" type="text" class="validate" name="id_dosen" value="Otomatis Terisi" readonly>
          <label for="icon_prefix">NIP</label>
    </div>
			<div class="input-field col s6">
      		<i class="material-icons prefix">lock</i>
          <input id="icon_prefix" type="text" class="validate" name="nm_dosen" required>
    ...
    <div class="input-field col s6">
		...
		<div class="input-field col s6">
				...
				<input id="icon_prefix" type="number" class="validate" name="tlp" required length="12">
